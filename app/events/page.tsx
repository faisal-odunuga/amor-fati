    ...
    <main className="min-h-screen pt-20">
      ...
      <section className="py-24 px-6">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl font-bold text-balance">Events & Experiences</h1>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <h2 className="font-serif text-3xl md:text-4xl font-bold">Realign Vision Board Retreat</h2>
              <p className="text-muted-foreground leading-relaxed">
                An immersive day of clarity, creativity, and realignment at the serene Ziba Beach. Create a powerful
                visual representation of your future while connecting with like-minded individuals on the path to
                transformation.
              </p>
        ...
        <div className="max-w-6xl mx-auto space-y-12">
          <div className="text-center space-y-4">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              The Realign Vision Board Retreat is more than an event — it's a transformative experience.
            </p>
          </div>
      ...
      <section className="py-24 px-6 bg-secondary/30">
        <div className="max-w-6xl mx-auto space-y-12">
          <div className="text-center space-y-4">
            ...
            <p className="text-lg text-muted-foreground">Moments of transformation and connection.</p>
          </div>
      ...
      <section className="py-24 px-6">
        <div className="max-w-6xl mx-auto space-y-12">
          <h2 className="font-serif text-3xl md:text-4xl font-bold text-center">What Participants Say</h2>
            ...
            {[
              ...
              <Card key={testimonial.author} className="border-border">
                <CardContent className="p-8 space-y-4">
                  <p className="text-lg text-muted-foreground leading-relaxed italic">"{testimonial.quote}"</p>
                  <div>
      ...
      <section className="py-24 px-6 bg-secondary/30">
        <div className="max-w-6xl mx-auto space-y-12">
          <div className="text-center space-y-4">
            <h2 className="font-serif text-3xl md:text-4xl font-bold">Overconfidence 101 Masterclasses</h2>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              90-minute transformative sessions for teams, schools, and organizations. Book a masterclass for your
              group.
            </p>
          </div>
      ...
      <section className="py-24 px-6">
        <div className="max-w-3xl mx-auto text-center space-y-6">
          <h2 className="font-serif text-3xl md:text-4xl font-bold">Your next chapter starts here</h2>
