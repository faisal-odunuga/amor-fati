    ...
    <main className="min-h-screen pt-20">
      ...
      <section className="py-24 px-6">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl font-bold text-balance">The Philosophy</h1>
      ...
      <section className="py-16 px-6 bg-secondary/30">
        <div className="max-w-6xl mx-auto space-y-16">
          <div className="text-center space-y-4">
            <h2 className="font-serif text-4xl md:text-5xl font-bold">Believe. Begin. Breakthrough. Become.</h2>
            ...
            {[
              ...
              >
                <div className={`space-y-4 ${index % 2 === 1 ? "md:order-2" : ""}`}>
                  <h3 className="font-serif text-2xl md:text-3xl font-bold text-balance">{principle.title}</h3>
                  <p className="text-muted-foreground leading-relaxed">{principle.description}</p>
                </div>
                <div
                  className={`relative aspect-video bg-muted rounded-lg overflow-hidden ${index % 2 === 1 ? "md:order-1" : ""}`}
                >
                  <img
