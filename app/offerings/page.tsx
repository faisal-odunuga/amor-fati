    ...
    <main className="min-h-screen pt-20">
      ...
      <section className="py-24 px-6">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl font-bold text-balance">Our Offerings</h1>
        ...
        <div className="max-w-6xl mx-auto space-y-12">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <Card key={offering.title} className="border-border hover:border-accent transition-colors">
                <CardHeader>
            ...
            <CardHeader>
              <div className="flex items-start gap-6">
                ...
                <div className="space-y-2">
                  <CardTitle className="font-serif text-3xl">Overconfidence 101 Masterclass</CardTitle>
                  <CardDescription className="text-lg">90-minute peak performance session</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent className="space-y-6">
              <p className="text-muted-foreground leading-relaxed">
                A high-energy, transformative masterclass designed to unlock unshakeable confidence in your team or
                students. Through interactive exercises, powerful frameworks, and real-world applications, participants
                learn to:
              </p>
