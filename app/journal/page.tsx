    ...
    <main className="min-h-screen pt-20">
      ...
      <section className="py-24 px-6">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl font-bold text-balance">Journal</h1>
          ...
          <Card className="border-border">
            ...
            <CardContent className="space-y-4">
              <p className="text-center text-muted-foreground leading-relaxed">
                Weekly insights on personal growth, philosophy, and creating a life worth reliving. No fluff, just
                substance.
              </p>
              ...
              <p className="text-xs text-center text-muted-foreground">Join 2,000+ readers. Unsubscribe anytime.</p>
            </CardContent>
          </Card>
        </div>
      </section>
      ...
      <section className="py-24 px-6 bg-secondary/30">
        <div className="max-w-4xl mx-auto space-y-8">
          <h2 className="font-serif text-3xl md:text-4xl font-bold text-center">Explore by Topic</h2>
