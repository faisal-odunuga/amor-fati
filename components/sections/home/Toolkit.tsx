...
import { freeResources } from '@/utils/data';
      ...
      <div className='max-w-7xl mx-auto'>
        <div className='flex flex-col md:flex-row justify-between items-end mb-16 gap-6'>
          <div>
            ...
            <h3 className='text-4xl sm:text-5xl font-serif font-bold text-foreground'>Essential Resources</h3>
          </div>
          <Link
            href='/shop'
        ...
        <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-10'>
          {freeResources.map((product, index) => (
            <div key={index} className='group'>
              <div className='bg-secondary/30 aspect-[3/4] p-6 sm:p-8 flex items-center justify-center mb-6 relative overflow-hidden'>
                <SiteImage
                  src={product.image}
                  alt={product.name}
                  width={700}
