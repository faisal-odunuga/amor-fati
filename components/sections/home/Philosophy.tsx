      ...
      <div className='max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 sm:gap-24 items-center'>
        <div className='relative'>
          <div className='aspect-[4/5] bg-muted overflow-hidden'>
            <SiteImage
              src='https://oufksmargaiutcykyjne.supabase.co/storage/v1/object/public/general/statue.png'
        ...
        <div>
          ...
          <h3 className='text-4xl sm:text-5xl font-serif font-bold mb-6 sm:mb-8 text-foreground'>
            Amor Fati: <br />
