    ...
    <section className='relative h-screen flex items-center overflow-hidden bg-background'>
      ...
      <div className='relative z-10 max-w-7xl mx-auto px-6 pt-20 w-full'>
        <div className='max-w-3xl animate-in fade-in slide-in-from-bottom-8 duration-1000'>
          ...
          <h1 className='text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-serif font-bold text-foreground mb-6 sm:mb-8 leading-tight'>
            Mastery of the <br /> <span className='italic text-primary'>Unconquerable</span> Mind.
          </h1>
          <p className='text-base md:text-xl text-muted-foreground mb-8 sm:mb-10 max-w-xl leading-relaxed'>
          ...
          <div className='flex flex-col sm:flex-row sm:flex-wrap gap-3 sm:gap-6'>
            <Button
              asChild
              size='lg'
              className='w-full sm:w-auto bg-primary text-primary-foreground px-6 sm:px-10 py-4 sm:py-6 h-auto text-xs sm:text-sm font-bold uppercase tracking-[0.2em] sm:tracking-widest hover:scale-105 transition-transform rounded-none'
            >
            ...
            <Button
              ...
              variant='outline'
              size='lg'
              className='w-full sm:w-auto border-primary/30 text-foreground px-6 sm:px-10 py-4 sm:py-6 h-auto text-xs sm:text-sm font-bold uppercase tracking-[0.2em] sm:tracking-widest hover:bg-primary hover:text-primary-foreground transition-all rounded-none'
            >
