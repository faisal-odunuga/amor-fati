      ...
      <div className='max-w-7xl mx-auto px-6'>
        <div className='grid lg:grid-cols-2 gap-20 items-center'>
          ...
          <div className='relative h-[420px] sm:h-[600px] w-full'>
            ...
            <SiteImage
              src='https://oufksmargaiutcykyjne.supabase.co/storage/v1/object/public/general/moh-sheriff.jpeg'
            ...
            />
            <div className='absolute bottom-6 sm:bottom-12 left-0 z-20 bg-background/90 backdrop-blur p-5 sm:p-8 max-w-sm border-l-4 border-primary'>
              <p className='font-serif italic text-base sm:text-lg text-foreground'>
