  ...
  return (
    <section className='relative h-[80vh] flex items-center justify-center overflow-hidden'>
      ...
      <div className='relative z-10 max-w-5xl mx-auto px-6 text-center space-y-8'>
        ...
        <h1 className='font-serif text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-black text-white leading-tight animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-200'>
          CHAOS IS THE <br /> <span className='italic text-primary'>CATALYST.</span>
        </h1>
        <p className='text-base sm:text-lg md:text-2xl text-slate-200 max-w-3xl mx-auto leading-relaxed font-light animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-400'>
