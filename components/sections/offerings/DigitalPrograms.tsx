              ...
              <div className='relative overflow-hidden rounded-xl mb-6 aspect-[4/5]'>
                ...
                <div className='absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex flex-col justify-end p-8'>
                  ...
                  <Link href={program.link} target='_blank'>
                    <button className='w-full bg-primary text-primary-foreground py-3 font-bold text-xs uppercase tracking-[0.2em] sm:tracking-widest hover:brightness-110 transition-all'>
                      {program.price}
                    </button>
                  </Link>
                </div>
