...
import { SUPABASE_GENERAL_BASE } from '@/utils/assets';
  ...
  return (
    <section className='relative h-[70vh] flex items-center justify-center text-center text-white px-4 overflow-hidden'>
      ...
      <div className='relative z-10 max-w-4xl space-y-6'>
        ...
        <h1 className='text-4xl sm:text-5xl md:text-7xl font-serif font-black mb-6 leading-tight animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-200'>
          MASTER EVERY AREA <br /> OF YOUR LIFE
        </h1>
        <p className='text-base md:text-xl text-slate-300 mb-8 sm:mb-10 max-w-2xl mx-auto font-light leading-relaxed animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-400'>
        ...
        <div className='flex flex-col sm:flex-row justify-center gap-4 animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-600'>
          <Button
            size='lg'
            className='w-full sm:w-auto bg-primary hover:brightness-110 text-primary-foreground font-bold uppercase tracking-[0.2em] sm:tracking-widest px-6 sm:px-10 py-4 sm:py-6 h-auto rounded-none'
          >
            Start Your Journey
          </Button>
          <Button
            size='lg'
            variant='outline'
            className='w-full sm:w-auto bg-white/10 backdrop-blur-md border border-white/20 text-white font-bold uppercase tracking-[0.2em] sm:tracking-widest hover:bg-white/20 px-6 sm:px-10 py-4 sm:py-6 h-auto rounded-none'
          >
            View All Offerings
          </Button>
        </div>
