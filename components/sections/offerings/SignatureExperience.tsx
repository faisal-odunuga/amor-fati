        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='grid lg:grid-cols-2 gap-16 items-center'>
            <div className='order-2 lg:order-1'>
              ...
              <Button
                size='lg'
                className='w-full sm:w-auto bg-primary hover:brightness-110 text-primary-foreground font-bold py-4 sm:py-6 px-6 sm:px-10 rounded-none transition-all text-xs sm:text-sm uppercase tracking-[0.2em] sm:tracking-widest h-auto'
              >
                Learn More & Register
              </Button>
            </div>
            <div className='order-1 lg:order-2'>
              <div className='relative group'>
                ...
                <SiteImage
                  ...
                  className='relative rounded-none shadow-2xl object-cover h-[360px] sm:h-[500px] w-full grayscale group-hover:grayscale-0 transition-all duration-700'
                />
              </div>
            </div>
          </div>
