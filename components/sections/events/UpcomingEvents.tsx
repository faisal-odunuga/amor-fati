    ...
    <section className='py-20 px-6'>
      <div className='max-w-7xl mx-auto'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-12 gap-8'>
          <div className='lg:col-span-8 group relative overflow-hidden rounded-2xl bg-black aspect-[16/9] md:aspect-auto min-h-[360px] sm:min-h-[500px]'>
            <SiteImage
            ...
            <div className='absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent'></div>
              ...
              <h3 className='text-2xl sm:text-3xl md:text-5xl font-serif font-bold text-white mb-4'>
                Unleash the Power Within
              </h3>
              <p className='text-slate-300 text-base sm:text-lg mb-6 sm:mb-8 max-w-xl'>
                The signature 4-day experience that will help you break through your limitations and
                take control of your life.
              </p>
              <div className='flex flex-wrap gap-4 items-center'>
                <Button className='bg-primary text-primary-foreground px-6 sm:px-8 py-4 sm:py-6 rounded-lg font-bold uppercase tracking-[0.2em] sm:tracking-wide text-xs sm:text-sm hover:scale-105 transition-transform hover:brightness-110'>
                  Learn More
                </Button>
