              ...
              <div className='md:col-span-7 space-y-6'>
                ...
                <div className='pt-4'>
                  <Button
                    ...
                    size='lg'
                    variant='outline'
                    className='w-full sm:w-auto rounded-none border-primary/50 text-foreground hover:bg-primary hover:text-primary-foreground font-bold uppercase tracking-[0.2em] sm:tracking-widest px-6 sm:px-8 text-xs sm:text-sm'
                  >
                    <Link href='/contact'>
